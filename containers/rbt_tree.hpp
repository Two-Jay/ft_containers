    ...
    class rbt_tree {
        ...
        public :
            ...
            insert(ft::pair<key_type, mapped_type>& __x) {
                ...
                pointer __tmp = this->create_node(__x.get_first(), __x.get_second(), this->_nil ,RED);
        ...
        private :
            ...
            void
            inline _rotate_left(pointer __x) {
            ...
            void
            inline _rotate_right(pointer __x) {
            ...
            rebalance_erase(pointer __x)
            {
                ...
                if (!is_nil_node(__x)) __x->change_color(BLACK);
            }
            ...
            print_aux(pointer node, std::string indent, bool isLast) const {
                if (node != _nil) {
                    ...
                    std::string sColor = is_nil_node(node) ? "NIL" : is_red_node(node) ? "RED" : "BLACK";
                    std::string sRoot = node == _root ? "ROOT" : "";
                    std::cout << node->_value->get_first() << ":" << sColor << sRoot << std::endl;
            ...
            erase_aux(pointer __t) {
                ...
                if (!is_nil_node(__t)) {
                    ...
                    if (is_nil_node(__x)) __x->_parent = __y->_parent;
                    if (is_nil_node(__y->_parent)) _root = __x;
                    else {
                        if (__y->is_left())
            ...
            adopt_node_to_parent(pointer __p, pointer __parent) {
                ...
                if (__parent == this->_nil)
                    ...
                    if (_comp(__p->_value->get_first(), __parent->_value->get_first()))
                        __parent->_left = __p;
                    else
                        __parent->_right = __p;
                }
            ...
            bool
            inline is_red_node(pointer __p) const {
                return __p && __p->_color == RED ? true : false;
            }

            bool
            inline is_black_node(pointer __p) const {
                return __p && __p->_color == BLACK ? true : false;
            }

            bool
            inline is_nil_node(pointer __p) const {
